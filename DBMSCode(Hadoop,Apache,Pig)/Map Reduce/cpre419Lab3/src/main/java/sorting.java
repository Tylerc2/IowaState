...
public class sorting {
	...
	public static void main(String[] args) throws Exception {
		...
		String input = "lab3/input-5m/";
		String temp = "lab3/e1/temp";
		String output = "lab3/e1/output"; 
		...
		InputSampler.Sampler<IntWritable, Text> sampler = new InputSampler.RandomSampler<IntWritable, Text>(0.2, 1000, 100);
	...
	public static class Map_One extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			k.set(value.toString().substring(0,15));
			v.set(value.toString().substring(16));
			context.write(k, v);
		} 
	} 
