...
public class WordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		JavaPairRDD<Integer,String> sorter = counts.mapToPair(new PairFunction<Tuple2<String, Integer>, Integer, String>() {
		...
		JavaPairRDD<Integer, String> sorted = sorter.sortByKey(false);
