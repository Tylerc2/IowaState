...
public class Q2 {
	...
	public static void main(String[] args) throws Exception {
		...
		// Sort Method
		job.setSortComparatorClass(comparing.class);
	...
	public static class comparing extends WritableComparator {
		...
		public int compare(byte[] b1, byte[] b2, int l1, int l2, int r1, int r2) {
			Integer v1 = ByteBuffer.wrap(b1, r1, l1).getInt();
			Integer v2 = ByteBuffer.wrap(b2, r2, l2).getInt();
